...
public class OAuth2Template implements OAuth2Operations {
	...
	private RestTemplateExt restTemplate;
	...
	/**
	 * Creates the {@link RestTemplateExt} used to communicate with the provider's OAuth 2 API.
	...
	protected RestTemplateExt getRestTemplate() {
