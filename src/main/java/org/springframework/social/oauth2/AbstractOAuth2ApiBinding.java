...
public abstract class AbstractOAuth2ApiBinding implements ApiBinding {
	 ...
	 * @see RestTemplateExt#setMessageConverters(java.util.List)
	 * @see RestTemplateExt#setErrorHandler(org.springframework.web.client.ResponseErrorHandler)
	 */
	public RestTemplateExt getRestTemplate() {
		return restTemplate;
	}
	 ...
	 */
	protected void configureRestTemplate(RestTemplateExt restTemplate) {		
	}

	/**
	 * Returns a list of {@link HttpMessageConverter}s to be used by the internal {@link RestTemplateExt}.
	...
	/**
	 * Returns an {@link FormHttpMessageConverter} to be used by the internal {@link RestTemplateExt}.
	...
	/**
	 * Returns a {@link MappingJacksonHttpMessageConverter} to be used by the internal {@link RestTemplateExt}.
	...
	/**
	 * Returns a {@link ByteArrayHttpMessageConverter} to be used by the internal {@link RestTemplateExt} when consuming image or other binary resources.
