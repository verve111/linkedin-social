 ...
 * @author Roy Clarkson
 */
public class ClientHttpRequestFactorySelector2 {
	
	public static ClientHttpRequestFactory2 getRequestFactory() {
	...
	private static boolean HTTP_COMPONENTS_AVAILABLE = ClassUtils.isPresent("org.apache.http.client.HttpClient", ClientHttpRequestFactory2.class.getClassLoader());

	private static class HttpComponentsClientRequestFactoryCreator {
		
		public static ClientHttpRequestFactory2 createRequestFactory(String proxyHost, int proxyPort) {
